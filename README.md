...
This repository contains all exercise submissions for the [DevOps with Kubernetes](https://devopswithkubernetes.com/) course by the University of Helsinki.
...
| [**1.6**](https://github.com/JuanitoSebastian/DevOps-With-Kubernetes/tree/1.6) | The project, step 4 | Completed |
...
| [**2.7**](https://github.com/JuanitoSebastian/DevOps-With-Kubernetes/tree/2.7/ping-pong) | Stateful applications | Completed |
| [**2.8**](https://github.com/JuanitoSebastian/DevOps-With-Kubernetes/tree/2.8/todo-app) | The project, step 11 | Completed |
